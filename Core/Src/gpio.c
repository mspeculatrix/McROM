...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(ZRST_GPIO_Port, ZRST_Pin, GPIO_PIN_SET);
  ...
  /*Configure GPIO pin : ZRST_Pin */
  GPIO_InitStruct.Pin = ZRST_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_OD;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(ZRST_GPIO_Port, &GPIO_InitStruct);
